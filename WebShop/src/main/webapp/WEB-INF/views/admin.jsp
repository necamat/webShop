    ...
    <body>
        ...
        <!-- END header -->
            ...
            <div class="card-body">
                ...
                <a href="<c:url value="/allorders" />" class="btn btn-secondary btn-md active" role="button" aria-pressed="true">Orders</a>
                <a href="<c:url value="/allproducts" />" class="btn btn-secondary btn-md active" role="button" aria-pressed="true">Products</a>
                   </div>
               </div>
            </div>
