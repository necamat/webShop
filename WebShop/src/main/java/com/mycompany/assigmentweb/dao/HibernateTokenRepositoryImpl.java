...
import com.mycompany.assigmentweb.model.PersistentLogin;
...
public class HibernateTokenRepositoryImpl extends AbstractDao<String, PersistentLogin> implements PersistentTokenRepository {
    ...
    public void createNewToken(PersistentRememberMeToken prmt) {
        logger.info("Creating Token for user : {}", prmt.getUsername());
        PersistentLogin persistentLogin = new PersistentLogin();
        persistentLogin.setUsername(prmt.getUsername());
        persistentLogin.setSeries(prmt.getSeries());
        persistentLogin.setToken(prmt.getTokenValue());
        persistentLogin.setLast_used(prmt.getDate());
